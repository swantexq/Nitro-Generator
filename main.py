...
class Console():        
 ...
 _______           _______  _        _______  _          _______  _______  _        _______  _______  _______  _       
(  ____ \|\     /|(  ____ )| \    /\(  ___  )( (    /|  (  ____ \(  ____ \| \    /\(  ____ \(  ____ )(  ____ \| \    /\
| (    \/| )   ( || (    )||  \  / /| (   ) ||  \  ( |  | (    \/| (    \/|  \  / /| (    \/| (    )|| (    \/|  \  / / 
| (__    | |   | || (____)||  (_/ / | (___) ||   \ | |  | |      | (__    |  (_/ / | (__    | (____)|| (__    |  (_/ / 
|  __)   | |   | ||     __)|   _ (  |  ___  || (\ \) |  | |      |  __)   |   _ (  |  __)   |     __)|  __)   |   _ (  
| (      | |   | || (\ (   |  ( \ \ | (   ) || | \   |  | |      | (      |  ( \ \ | (      | (\ (   | (      |  ( \ \ 
| )      | (___) || ) \ \__|  /  \ \| )   ( || )  \  |  | (____/\| (____/\|  /  \ \| (____/\| ) \ \__| (____/\|  /  \ \
|/       (_______)|/   \__/|_/    \/|/     \||/    )_)  (_______/(_______/|_/    \/(_______/|/   \__/(_______/|_/    \/
...
class Worker():              
    ...
    def run(self):
        self.code = "".join(random.choice("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890") for _ in range(26))
        try:
